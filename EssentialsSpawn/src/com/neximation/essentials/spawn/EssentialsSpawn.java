...
public class EssentialsSpawn extends JavaPlugin implements IEssentialsSpawn {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String commandLabel, final String[] args) {
        return ess.onCommandEssentials(sender, command, commandLabel, args, EssentialsSpawn.class.getClassLoader(), "com.neximation.essentials.spawn.Command", "essentials.", spawns);
    }
