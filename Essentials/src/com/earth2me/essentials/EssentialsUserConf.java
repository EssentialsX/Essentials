...
public class EssentialsUserConf extends EssentialsConf implements IEssentialsConf {
	...
	private File getAltFile() {
		final UUID fn = UUID.nameUUIDFromBytes( ( "OfflinePlayer:" + username.toLowerCase( Locale.ENGLISH ) )
	...
	@Override
	public void reload() throws InvalidConfigurationException, SQLException {
		super.load();
	}
}
