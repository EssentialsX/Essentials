...
public class ItemDb implements IConf, net.ess3.api.IItemDb {
    ...
    private final transient List<Material> items = new ArrayList<>();
    ...
    public void reloadConfig() {
        ...
        for (String line : lines) {
            ...
            while (matcher.find()) {
                ...
                itemName = match.toUpperCase(Locale.ENGLISH);
            }
            // Invalid row
            if (itemName == null) {
                continue;
            ...
            items.add(mat);
//            if (nbt != null) {
//                nbtData.put(mat, mat.data);
//            }

            ItemData itemData = new ItemData(mat, mat.getMaxDurability()); // TODO: Should be changed
    ...
    public ItemStack get(final String id) throws Exception {
        ...
        itemname = itemname.toUpperCase(Locale.ENGLISH);
    ...
    public String serialize(ItemStack is) {
        ...
        switch (is.getType()) {
            ...
            case POTION:
                ...
                break;
            case PLAYER_HEAD: // TODO: This might be wrong. Before it was all skulls
    ...
    static class ItemData {
        final private Material mat;
        final private short itemData;

        ItemData(final Material mat, final short itemData) {
            this.mat = mat;
        ...
        public boolean equals(Object o) {
            ...
            return this.mat == pairo.getMat() && this.itemData == pairo.getItemData();
        }
    }
