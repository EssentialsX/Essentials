...
public class Commandnick extends EssentialsLoopCommand {
    ...
    private String formatNickname(final User user, final String nick) throws Exception {
        ...
        } else if (ess.getSettings().getBlackListedNickNames() != null && !ess.getSettings().getBlackListedNickNames().isEmpty() &&
                   !user.isAuthorized("essentials.nick.disablednames.bypass") && ess.getSettings().getBlackListedNickNames().contains(nick)) {
