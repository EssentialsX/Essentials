...
public abstract class UserData extends PlayerExtension implements IConf {
    ...
    private List<Material> _getUnlimited() {
        return stringToMaterial(config.getStringList("unlimited"));
    }
    ...
    private static List<Material> stringToMaterial(List<String> strings) {
        ...
        for (String s : strings) {
            materials.add(Material.getMaterial(s.toUpperCase(Locale.ENGLISH)));
        }
        return materials;
    }
    ...
    public List<String> getPowertool(Material type) {
        return (List<String>) powertools.get("" + type);
    }
