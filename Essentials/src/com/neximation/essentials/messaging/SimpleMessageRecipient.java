package com.neximation.essentials.messaging;

import static com.neximation.essentials.I18n.tl;

import com.neximation.essentials.Console;
import com.neximation.essentials.IEssentials;
import com.neximation.essentials.IUser;
...
public class SimpleMessageRecipient implements IMessageRecipient {
     ...
     * {@inheritDoc}
     * <p />
     * <b>This {@link com.neximation.essentials.messaging.SimpleMessageRecipient} implementation stores the a weak reference to the recipient.</b>
     */
    @Override
