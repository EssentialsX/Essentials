package com.neximation.essentials.register.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.neximation.essentials.register.payment.methods.iCo6());
        addMethod("iConomy", new com.neximation.essentials.register.payment.methods.iCo5());
        addMethod("BOSEconomy", new com.neximation.essentials.register.payment.methods.BOSE7());
        addMethod("Currency", new com.neximation.essentials.register.payment.methods.MCUR());
        Dependencies.add("MultiCurrency");
        addMethod("Vault", new com.neximation.essentials.register.payment.methods.VaultEco());
    }
