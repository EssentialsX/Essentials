...
public class Commandtpr extends EssentialsCommand {
    ...
    protected void run(final Server server, final User user, final String commandLabel, final String[] args) throws Exception {
        ...
        final World world = randomTeleport.getPerWorld() ? user.getWorld() : null;
        final UserRandomTeleportEvent event = new UserRandomTeleportEvent(user, world, randomTeleport.getCenter(world), randomTeleport.getMinRange(world), randomTeleport.getMaxRange(world));
