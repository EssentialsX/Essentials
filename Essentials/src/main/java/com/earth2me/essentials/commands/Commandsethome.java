...
public class Commandsethome extends EssentialsCommand {
    ...
    public void run(final Server server, final User user, final String commandLabel, String[] args) throws Exception {
        ...
        if (!ess.getSettings().isTeleportSafetyEnabled() && LocationUtil.isBlockUnsafeForUser(ess, usersHome, location.getWorld(), location.getBlockX(), location.getBlockY(), location.getBlockZ())) {
