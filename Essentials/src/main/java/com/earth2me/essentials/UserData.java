...
public abstract class UserData extends PlayerExtension implements IConf {
    ...
    protected UserData(final Player base, final IEssentials ess) {
        ...
        try {
            ...
            EssentialsLogger.getLogger().warning("Falling back to old username system for " + base.getName());
    ...
    public final void reloadConfig() {
        ...
        try {
            ...
            EssentialsLogger.getLogger().log(Level.SEVERE, "Error while reading user config: " + config.getFile().getName(), e);
        ...
        config.setSaveHook(() -> {
            try {
                ...
                EssentialsLogger.getLogger().log(Level.SEVERE, "Error while saving user config: " + config.getFile().getName(), e);
                throw new RuntimeException(e);
            }
        });
        money = _getMoney();
