...
public class EssentialsXMPP extends JavaPlugin implements IEssentialsXMPP {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String commandLabel, final String[] args) {
        return ess.onCommandEssentials(sender, command, commandLabel, args, EssentialsXMPP.class.getClassLoader(), "com.neximation.essentials.xmpp.Command", "essentials.", null);
    }
